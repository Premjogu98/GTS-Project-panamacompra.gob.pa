    ...
    while a == 0:
        try:
            ...
            string_Translate_Table = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\">" +\
                        "<BODY>"
            Final_Doc = string_Translate_Table + get_htmlSource + "</BODY></HTML>"
            ...
            Final_HTML_Document = Final_Doc + "<hr><div><a href=\"http://www.panamacompra.gob.pa/portal/Legislacion.aspx\"><h2>Panama Compra Legislation<h2></a></div></body>"
            Final_Doc_list = []
...
def insert_L2L(SegFeild , Fileid):
    ...
    Col1 = 'http://www.panamacompra.gob.pa'
    if SegFeild[7] == "IN":
